    ...
    <div className={styles.container}>
      ...
      <div className={styles.content}>
        ...
        <Form className="login-form" onFinish={onFinish} form={form}>
          ...
          <FormItem name="code">
            <Row gutter={8} justify="space-between">
              ...
              <Col span={8} style={{ textAlign: 'end' }}>
                <Button disabled={!/^1[3456789]\d{9}/.test(phone)} onClick={() => getCodeApi({ phone })}>
                  获取验证码
                </Button>
              </Col>
            </Row>
          ...
          <FormItem>
            <Button disabled={code.length !== 6} type="primary" htmlType="submit" block className={styles.button}>
              登录
            </Button>
          </FormItem>
        </Form>
