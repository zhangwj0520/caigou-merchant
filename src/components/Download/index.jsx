...
export default () => {
  ...
  return (
    <Popover
      ...
      // content={
      //   <ExportLog data={exportLogList} loading={logListLoading}
      //  onRetry={handleExportLogRetry} />
      // }
    >
      <div className="download">
        ...
        <span className="download-dot" style={{ display: showloglistdot ? 'inline-block' : 'none' }} />
      </div>
    </Popover>
  );
};
